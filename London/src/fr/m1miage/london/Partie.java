...
public class Partie {
	...
	private Boolean restaurerVille() {
		...
		// on regarde s'il est possible de restaurer la ville avec ces cartes s�lectionn�es
		listeJoueurs.get(joueurActif).restaurerVille(listVal);
		// le cout de l'activation est charg� dans la classe statique TraderClassRestaurerVille
		...
		// s'il n'y a que de l'argent � payer
		if (TraderClassRestaurerVille.getNbCartesBleues() == 0 
