...
public class EtalageTest {
	...
	public void testAjouterCarte(){
		...
		Carte c1 = new Carte(2,"nom","A",2,"Rouge",1,1,1,"toto",1,true,1,1,1,1);
		e.ajouterCarte(c1);
		assertEquals(2, e.getRangee2().get(1).getId_carte());
		Carte c2 = new Carte(3,"nom","A",2,"Rouge",1,1,1,"toto",1,true,1,1,1,1);
		e.ajouterCarte(c2);
		assertEquals(3, e.getRangee2().get(2).getId_carte());
		Carte c3 = new Carte(4,"nom","A",2,"Rouge",1,1,1,"toto",1,true,1,1,1,1);
		e.ajouterCarte(c3);
		assertEquals(4, e.getRangee2().get(3).getId_carte());
		Carte c4 = new Carte(5,"nom","A",2,"Rouge",1,1,1,"toto",1,true,1,1,1,1);
		e.ajouterCarte(c4);
		Carte c5 = new Carte(6,"nom","A",2,"Rouge",1,1,1,"toto",1,true,1,1,1,1);
		e.ajouterCarte(c5);
